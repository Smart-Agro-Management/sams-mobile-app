...
export default class FarmerListStock extends Component {
    constructor(props){
        super(props);
    ...
    shadowOpacity: 0.5,
    shadowRadius: 20,}}>
                <TouchableOpacity style={{flexDirection: 'row'}} onPress={() => this.props.navigation.navigate('Stock', {username: val.Username, category: UserCategory,})}>
