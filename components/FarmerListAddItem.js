...
export default class FarmerListAddItem extends Component {
    constructor(props){
        super(props);
    ...
    borderRadius: 10,
                ...
                <View style={{flexDirection: 'row'}}>
                    <View style={{flexDirection: 'row'}}>
                        <TextInput placeholder="Type farmer's Username" style={{backgroundColor: 'rgba(240,240,240,1)', margin: 5, borderRadius: 10, width: 260}} onChangeText={(SearchName)=> this.setState({SearchName})} value={this.state.SearchName}></TextInput>
                    </View>
    ...
    shadowOpacity: 0.5,
    shadowRadius: 20,}}>
                <TouchableOpacity style={{flexDirection: 'row'}} onPress={() => this.props.navigation.navigate('AddItem', {username: val.Username})}>
